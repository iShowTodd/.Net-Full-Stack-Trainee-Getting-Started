namespace StringMethods
{
    internal class Program
    {
        ...
        private static void RunStringFound()
        {
            // ascii sort order (integer, capital, small)
            string s1 = "metigator";
        ...
        private static void RunStringFormat()
        {
        ...
        private static void RunStringIsNullOrEmpty()
        {
            string s1 = "metigator";
            string s2 = "";
            string s3 = "   ";
        ...
        private static void RunStringIsNullOrWhiteSpace()
        {
            string s1 = "metigator";
            string s2 = "";
            string s3 = "   ";
        ...
        private static void RunStringModify()
        {
            string s1 = "metior";
            string s2 = "metizanor";
        ...
        private static void RunToCharacterArray()
        {
            string s1 = "metigator";
            char[] characters;
        ...
        private static void RunStringJoin()
        {
