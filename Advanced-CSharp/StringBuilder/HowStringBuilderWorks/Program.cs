...
namespace HowStringBuilderWorks
{
    internal class Program
    {
        ...
        private static void RunArrayOfCharacterConcept()
        {
        ...
        private static void RunStringBuilderProperties()
        {
        ...
        private static void RunStringBuilderHowItWorks()
        {
