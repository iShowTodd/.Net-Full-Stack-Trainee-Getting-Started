...
namespace CAJsonSerializer
{
    internal class Program
    {
        ...
        private static Employee DeserializeToJsonStringNewSoftJson(string jsonContent)
        {
        ...
        private static string SerializeToJsonStringUsingJSONNET(Employee employee)
        {
            var result = "";
        ...
        private static Employee DeserializeToJsonStringJSONNET(string jsonContent)
        {
            Employee employee = null;
            employee = JsonConvert.DeserializeObject<Employee>(jsonContent);
            return employee;
